        ...
        <div className={"bg-white p-10 rounded-lg text-gray-800 mx-3"}>
            <div>
                ...
                <div className={"text-sm lg:text-md"}>
                    <p>We have sent an email to <span className={"text-btn-secondary font-bold"}>{email}</span> to
                        confirm the validity of your email
                        address.</p>
            ...
            <form className={""}>
                <div className={"flex flex-col justify-center items-center"}>
                    {
                        !loading && <div className="flex flex-col justify-between items-start gap-2 mt-5  ">
                            <div>
                                <label htmlFor="email" className={"lg:text-md text-sm font-bold"}>Confirmation Code</label>
                            </div>
                            <input type={"email"} className={"input-field outline-black hover:outline-black"}
                    ...
                    {!loading ?
                        ...
                        </div> : <div className={"mt-5"}><Loading/></div>
                    }
